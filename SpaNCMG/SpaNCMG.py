...
class Mix_SpaNCMG(torch.nn.Module):
    def __init__(self,in_features, out_features,esparse=False):
        super(Mix_SpaNCMG, self).__init__()
        
        self.attention1 = Attention(out_features) #64
        self.attention2 = Attention(in_features) #3000
        self.attention3 = Attention(2)
        self.spancmg = SpaNCMG(in_features, out_features,esparse)
        
    def forward(self,features, features_a, adj1,adj2, graph_neigh1,graph_neigh2):
        hiden_emb1, h1, ret1, ret_a1 = self.spancmg(features, features_a, adj1, graph_neigh1)
        hiden_emb2, h2, ret2, ret_a2 = self.spancmg(features, features_a, adj2, graph_neigh2)
