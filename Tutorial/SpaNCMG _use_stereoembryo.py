...
adata = train_SpaNCMG(adata,n_epochs=550)
sc.pp.neighbors(adata, use_rep='SpaNCMG')
sc.tl.umap(adata)

print('Start clustering')
adata = mclust_R(adata, used_obsm='SpaNCMG', num_cluster=n_clusters)
...
sc.pl.embedding(adata, basis="spatial", color="mclust",s=30, show=False,palette=plot_color, title='SpaNCMG')#,save='_stereo_embryo01.png'
plt.axis('off')
sc.pl.umap(adata, color='mclust', title='SpaNCMG',save='_stereo_embryo02.png')
