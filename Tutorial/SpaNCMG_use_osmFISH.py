...
adata = train_SpaNCMG(adata,n_epochs=450)
...
sc.pl.umap(adata, color="mclust", title='SpaNCMG (ARI=%.2f)'%ARI)
plt.rcParams["figure.figsize"] = (5, 5)
sc.pl.embedding(adata,basis='spatial',color="mclust", title='SpaNCMG (ARI=%.2f)'%ARI,show=False)
