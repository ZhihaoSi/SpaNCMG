...
plt.rcParams["figure.figsize"] = (3, 3)
sc.pl.umap(adata, color=["mclust", "Ground Truth"], title=['SpaNCMG (ARI=%.2f)'%ARI, "Ground Truth"],save='_%.2f_U.png'%ARI)
plt.rcParams["figure.figsize"] = (3, 3)
sc.pl.spatial(adata, color=["mclust", "Ground Truth"], title=['SpaNCMG (ARI=%.2f)'%ARI, "Ground Truth"],save='_%.2f_C.png'%ARI)
