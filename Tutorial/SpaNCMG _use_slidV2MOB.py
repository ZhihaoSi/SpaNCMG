...
input_dir = '/home/szh/upload/DATA/slide2_MOB/'
...
adata = train_SpaNCMG(adata,n_epochs=300)#300
...
sc.pl.embedding(adata, basis="spatial", color="louvain",s=6, show=False, title='SpaNCMG',save='_MOB03_SpaNCMG.png')
plt.axis('off')

sc.pl.umap(adata, color='louvain', title='SpaNCMG',save='_MOB04_UMAP.png')
