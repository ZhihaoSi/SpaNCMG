...
adata = train_STNCMG(adata,n_epochs=100)#100
sc.pp.neighbors(adata, use_rep='STNCMG')
sc.tl.umap(adata)
sc.tl.louvain(adata, resolution=0.8)
plt.rcParams["figure.figsize"] = (3, 3)
sc.pl.embedding(adata, basis="spatial", color="louvain",s=6, show=False, title='STNCMG')#,save='_stereo_MOB03_UMAP.png')
plt.axis('off')

sc.pl.umap(adata, color='louvain', title='STNCMG') #,save='_stereo_MOB04_UMAP.png')
